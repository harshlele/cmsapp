  ...
  return (
    <div className='App flex'>
      <div className='mt-16 md:mt-32 p-8 login mx-auto w-10/12 md:w-1/3 h-80 border-2 border-green-600 rounded-lg'>
        ...
        <button className='my-2 border-2 border-green-800 rounded-md px-5 py-2 mx-2 active:text-white active:bg-green-700' onClick={() => login('login')}>Login</button>
        <button className='my-2 border-2 border-green-800 rounded-md px-5 py-2 mx-2 active:text-white active:bg-green-700' onClick={() => login('signup')}>Sign Up</button>
      </div>
    </div>
  );
}
